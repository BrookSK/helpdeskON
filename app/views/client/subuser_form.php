<?php $pageTitle = ($editUser ? 'Editar' : 'Novo') . ' Usuário - ON Solutions Helpdesk'; $currentPage = 'subusers'; ?>
...
<div class="main-content">
    <div class="top-bar">
        <div>
            <h5 class="mb-0"><?= $editUser ? 'Editar Usuário' : 'Novo Usuário da Equipe' ?></h5>
            <small class="text-muted"><?= $editUser ? escape($editUser['name']) : 'Cadastrar novo membro da equipe' ?></small>
        </div>
        <a href="<?= baseUrl('subusers') ?>" class="btn btn-outline-secondary btn-sm"><i class="bi bi-arrow-left"></i> Voltar</a>
    </div>
    ...
    <div class="card" style="max-width:600px">
        <div class="card-body">
            <form action="<?= baseUrl($editUser ? 'subusers/update/' . $editUser['id'] : 'subusers/store') ?>" method="POST">
                <div class="row g-3">
                    <div class="col-sm-6">
                    ...
                    <div class="col-12">
                        <div class="alert alert-info py-2" style="font-size:0.82rem">
                            <i class="bi bi-info-circle"></i> Um email será enviado com as credenciais de acesso.
                        </div>
                    </div>
                    <?php endif; ?>
