...
<div class="main-content">
    ...
    <div style="max-width:820px">
        <!-- Cabeçalho da ficha: avatar, nome, papel e status -->
        <div class="card mb-3">
        ...
        <!-- Ação: abrir o formulário de edição existente -->
        <div class="d-flex justify-content-end">
            <a href="<?= baseUrl('users/edit/' . $viewUser['id']) ?>" class="btn btn-primary px-4">
