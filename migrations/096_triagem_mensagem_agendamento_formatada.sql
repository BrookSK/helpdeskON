-- =====================================================================
-- 096_triagem_mensagem_agendamento_formatada.sql  (substitui 095)
-- ---------------------------------------------------------------------
-- Regrava a sequência "ON Solu · Triagem IA (pós-resposta)" com a mensagem
-- do bloco de AGENDAMENTO bem formatada e preenchida, e mantendo:
--   * Resposta ao lead pelo MESMO canal (bloco 'reply')
--   * Envio do link de agendamento pelo mesmo canal (schedule channel=reply)
--   * A confirmação (com o link do Meet) é enviada automaticamente pelo
--     BookingController quando o lead escolhe o horário.
--
